...
jQuery(function ($) {
    ...
    if(cookieNotice) {
        ...
        gdprCookieNoticeLocales.fr = {
            ...
            cookie_essential_desc : "Les cookies essentiels contribuent à rendre un site web utilisable en permettant des fonctions de base comme la navigation dans les pages et l'accès aux zones sécurisées du site web. Le site web ne peut pas fonctionner correctement sans ces cookies.",
            cookie_performance_title : "Cookies de performance",
            cookie_performance_desc : 'Ces cookies sont utilisés pour améliorer les performances et les fonctionnalités de nos sites web mais ne sont pas essentiels à leur utilisation. Par exemple, ils enregistrent votre langue préférée ou la région dans laquelle vous vous trouvez.',
            cookie_analytics_title : "Cookies d'analyse",
            cookie_analytics_desc : "Nous utilisons des cookies d'analyse pour nous aider à mesurer comment les utilisateurs interagissent avec le contenu du site Web, ce qui nous aide à personnaliser nos sites Web et notre application pour vous afin d'améliorer votre expérience.",
            cookie_marketing_title : "Cookies de marketing",
            cookie_marketing_desc : "Ces cookies sont utilisés pour rendre les messages publicitaires plus pertinents pour vous et vos intérêts. L'intention est d'afficher des annonces qui sont pertinentes et engageantes pour l'utilisateur individuel et qui ont donc plus de valeur pour les éditeurs et les annonceurs tiers."
        }

        gdprCookieNoticeLocales.nl = {
            description: "Wij gebruiken cookies om u een betere browse-ervaring te bieden, inhoud en advertenties te personaliseren, functies voor sociale media aan te bieden en ons verkeer te analyseren. Lees meer over hoe wij cookies gebruiken en hoe u ze kunt controleren door te klikken op Cookie-instellingen. U stemt in met onze cookies als u deze website blijft gebruiken.",
            ...
            cookie_essential_desc: "Noodzakelijke cookies helpen een website bruikbaar te maken door basisfuncties zoals paginanavigatie en toegang tot beveiligde delen van de website mogelijk te maken. Zonder deze cookies kan de website niet goed functioneren.",
            cookie_performance_title: "Prestatiecookies",
            cookie_performance_desc: "Deze cookies worden gebruikt om de prestaties en functionaliteit van onze websites te verbeteren, maar zijn niet essentieel voor het gebruik ervan. Ze slaan bijvoorbeeld uw voorkeurstaal op of de regio waarin u zich bevindt.",
            cookie_analytics_titel: "Analytics cookies",
            cookie_analytics_desc: "Wij gebruiken analytische cookies om ons te helpen meten hoe gebruikers omgaan met de inhoud van de website, wat ons helpt onze websites en applicatie voor u aan te passen om uw ervaring te verbeteren",
            cookie_marketing_title: "Marketing cookies",
            cookie_marketing_desc: "Deze cookies worden gebruikt om reclameboodschappen relevanter te maken voor u en uw interesses. De bedoeling is om advertenties weer te geven die relevant en aantrekkelijk zijn voor de individuele gebruiker en daardoor waardevoller zijn voor uitgevers en externe adverteerders.", 
        }
...
jQuery(function ($) {
    ...
    translations.debug = {
        ...
        "navbar_text": "Nos conseillers répondent à vos questions du lundi au vendredi, de 9h à 18h.",
        "menu_item1": "Accueil",
        "menu_item2": "Services",
        "menu_item3": "Équipe",
        ...
        "hero_item1_body": "Sed in orci nunc. Donec sit amet ante et dolor commodo venenatis vitae nec odio.",
        "hero_item2_title": "Conseils juridiques",
        "hero_item2_body": "Nos juristes vous fournissent assistance et conseil afin que votre entreprise puisse constamment répondre aux exigences légales et réglementaires en vigueur.",
        "hero_item3_title": "Gestion d'entreprise",
        "hero_item3_body": "Notre équipe vous accompagne et vous assiste lors de la création de votre entreprise et tout au long de votre activité.",
        "hero_item4_title": "Gestion du personnel",
        "hero_item4_body":"Nos spécialistes RH vous aident à recruter de nouveaux collaborateurs et s’occupent de la gestion salariale de votre entreprise en vous garantissant le respect de la législation sociale en vigueur.",
        ...
        "services_body": "Nous sommes spécialisés dans la prestation de services de conseil grâce à un ensemble de technologies de pointe et à une équipe de professionnels expérimentés. Voici un aperçu des options que vous pouvez engager.",
        ...
        "study_cases_body": "Chaque mois, nous publions une étude de cas afin de vous faire découvrir comment notre expertise a contribué au développement et à la croissance de ceux qui nous ont fait confiance.",
        "study_cases_cta_more": "Découvre nos cas d'étude",
        
        "newsletter_pre_title": "Newsletter",
        "newsletter_title_beginning": "Apprenez-en ",
        "newsletter_title_highlighted_end": "plus",
        "newsletter_body": "Grâce à nos newsletters, recevez nos cas d'étude, découvrez nos conseils en matière de gestion d'entreprise et gardez un oeil sur les dernières nouveautés en termes de fiscalité et législation.",
        ...
        "testimonials_body": "Nous travaillons intensément à la recherche d'idéaux et de solutions qui peuvent avoir un effet positif sur la vie de nos clients. C'est ce qui nous anime et nous sommes sensibles à toute cette reconnaissance.",
        "testimonials_cta_more": "Découvre nos cas d'étude",

        "contact_pre_title": "Écrivez-nous",
        "contact_title_beginning": "Dites-nous ",
        "contact_title_highlighted_end": "tout",
        "contact_body": "Dites-nous en plus sur votre situation et vos projets. Nous accorderons une attention particulière à votre message et vous répondrons dans les meilleurs délais.",
    ...
    function changeLanguage(lng){
        ...
        var resources = translations[lng];

        $("[data-translation-key]").each(function(i, elt){
            $(elt).text(resources[$(elt).attr("data-translation-key")]);
        });
        $("[placeholder-translation-key]").each(function(i, elt){
            $(elt).attr("placeholder", resources[$(elt).attr("placeholder-translation-key")]);
        });
    ...
    $(document).ready(function() {
        ...
        if(initialLanguage === null) {
            const potentialLng = (navigator.languages.find((language) => {
                const isoLng = language.slice(0, 2)
                return isoLng == 'fr' || isoLng == 'nl' || isoLng == 'en'
            }) || navigator.userLanguage || navigator.language).slice(0, 2).toLowerCase();
